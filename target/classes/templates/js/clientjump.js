...
function GetWapUrl() {
    ...
    if (pageurl.indexOf("/groupbuyproductdetails") > -1) { return "groupbuyproductdetails" + pageurl.replace("/groupbuyproductdetails", "").replace(param.toLowerCase(), "") + param.replace("?", "&");; }
    if (pageurl.indexOf("/countdownproductsdetails") > -1) { return "countdownproductsdetails" + pageurl.replace("/countdownproductsdetails", "").replace(param.toLowerCase(), "") + param.replace("?", "&");; }
